...
/**
 * Classe que representa um PieChart com os votos de todos os partidos das europeias.
 * 
 * @author henri
 */
public class PieChartEuropeanVotes extends AnchorPane{
    
    private final EuropeanElection election;
    
    /**
     * Constroí um PieChart com os votos de todos os partidos das concelhos.
     * 
     * @param election eleição
     */
    public PieChartEuropeanVotes(EuropeanElection election){
        this.election = election;
        show();
    }
    
    /**
     * Método que cria toda a interface dos votos de todos os partidos das concelhos.
     */
    private void show(){
