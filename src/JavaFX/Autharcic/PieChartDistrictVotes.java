...
/**
 * Classe que representa um PieChart com os votos de todos os partidos dos distritos.
 * 
 * @author henri
 */
public class PieChartDistrictVotes extends AnchorPane {
    
    private final AutharcicElection election;
    
    /**
     * Constroí um PieChart com os votos de todos os partidos dos distritos.
     * 
     * @param election eleição
     */
    public PieChartDistrictVotes(AutharcicElection election){
        this.election = election;
        show();
    }
    
    /**
     * Método que cria toda a interface dos votos de todos os partidos dos distritos.
     */
    private void show(){
        HashMap<String, Integer> temp = election.numberOfVotesPerPoliticalParty(1);
