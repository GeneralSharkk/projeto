...
/**
 * Classe que representa um PieChart com os votos de todos os partidos das freguesias.
 * 
 * @author henri
 */
public class PieChartParishVotes extends AnchorPane {
    
    private final AutharcicElection election;
    
    /**
     * Constroí um PieChart com os votos de todos os partidos das freguesias.
     * 
     * @param election eleição
     */
    public PieChartParishVotes(AutharcicElection election){
        this.election = election;
        show();
    }
    
    /**
     * Método que cria toda a interface dos votos de todos os partidos das freguesias.
     */
    private void show(){
        HashMap<String, Integer> temp = election.numberOfVotesPerPoliticalParty(3);
