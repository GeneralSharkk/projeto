...
/**
 * Classe que representa um PieChart com as taxas de absencao dos distritos.
 * 
 * @author henri
 */
public class PieChartDistrictAbstention extends AnchorPane{
    
    private final AutharcicElection election;
    
    /**
     * Constroí um PieChart com as taxas de absencao dos distritos.
     * 
     * @param election eleição
     */
    public PieChartDistrictAbstention(AutharcicElection election){
        this.election = election;
        show();
    }
    
    /**
     * Método que cria toda a interface das taxas de absencao dos distritos.
     */
    private void show(){
        final double percentageAb = election.calculateAbstentionRateALT(1);
